...
export class FormularioInspeccionEmergencia extends Document {
  ...
  @Prop({ type: String, enum: ["ENERO-JUNIO", "JULIO-DICIEMBRE"], required: true })
  ...
  @Prop({ type: String, enum: ["activo", "completado", "archivado"], default: "activo" })
  estado: "activo" | "completado" | "archivado"
}

export const FormularioInspeccionSchema = SchemaFactory.createForClass(FormularioInspeccionEmergencia)

FormularioInspeccionSchema.index({ superintendencia: 1, area: 1, año: 1, mesActual: 1 })